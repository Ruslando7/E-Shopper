                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            ...
                            <?php
                            if ($product->new) echo Html::img("@web/images/home/new.png", ['alt' => '', 'class' => 'newarrival']);
                            else if ($product->sale) echo Html::img("@web/images/home/sale.png", ['alt' => '', 'class' => 'newarrival']);
                            ?>
                            <h3>ZOOM</h3>
                        </div>
...
<!--                                        <a href=""><img src="--><?//=$img->getUrl()?><!--" alt="" height="84px" width="85px"></a>-->
